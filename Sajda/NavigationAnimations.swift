// MARK: - BUAT FILE BARU: Sajda/NavigationAnimation+Custom.swift
...
extension NavigationAnimation {
    ...
    static let smooth: NavigationAnimation = NavigationAnimation(
        animation: .easeInOut(duration: 0.25), // Sedikit lebih cepat untuk nuansa responsif
